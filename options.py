...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--unlabelled', action='store_false', help='train with the unlabelled data')
        ...
        self.parser.add_argument('--alpha', default=0.9, type=float, help='the update weight of batch proto in the '
                                                                          'new proto memory')
        self.parser.add_argument('--loss_type', type=int, default=1, help='loss_type in [0, 1], 0: CE, 1: CE+KL')
